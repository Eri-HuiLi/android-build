...
import com.yunx.app.data.network.CfileConstants
...
class ResolveViewModel(
    ...
    private val cfileAccountRepository: CfileAccountRepository,
    private val cfileResolveRepository: CfileResolveRepository,
    ...
    private suspend fun currentCredential(): String? = when (currentPlatform) {
        ...
        SharePlatform.CTFILE -> cfileAccountRepository.getToken()
    ...
    private fun currentRepo(): ShareResolveRepository = when (currentPlatform) {
        ...
        SharePlatform.CTFILE -> cfileResolveRepository
    ...
    private suspend fun enqueueDownload(
        ...
        val isCfile = currentPlatform == SharePlatform.CTFILE
        ...
        val headers = when {
            ...
            // 城通：直链为 CDN 签名地址，需带 Referer（对齐 CtfileUrlDecoder 行为）
        isCfile -> mapOf(
            "User-Agent" to CfileConstants.WEB_UA,
            "Referer" to CfileConstants.REFERER
        )
    ...
    class Factory(
        ...
        override fun <T : ViewModel> create(modelClass: Class<T>): T {
            ...
            return ResolveViewModel(
                ...
                cfileAccountRepository, cfileResolveRepository,
                downloadManager
            ) as T
        }
    }
